    ...
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-950 via-purple-950 to-slate-900">
      ...
      <nav className="glass-strong sticky top-0 z-50 border-b border-purple-500/20">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <SignInButton mode="modal">
            <button className="group relative px-8 py-3 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 rounded-2xl text-white font-bold text-sm shadow-2xl hover:shadow-purple-500/50 transition-all duration-300 hover:scale-105 flex items-center gap-2 overflow-hidden animate-gradient">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 animate-slide-up">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-strong border border-purple-500/30">
              ...
              <span className="px-2 py-0.5 rounded-full bg-purple-600 text-xs text-white">Live</span>
            </div>
            ...
            <h1 className="text-6xl lg:text-8xl font-black leading-tight">
              ...
              <span className="block text-white mt-2 neon-text">
                Interview Better
              </span>
            </h1>

            <p className="text-xl text-purple-200 leading-relaxed max-w-xl">
              Experience the future of technical interviews with <span className="text-pink-400 font-bold">real-time video</span>, 
              <span className="text-blue-400 font-bold"> collaborative coding</span>, and 
              <span className="text-purple-400 font-bold"> instant execution</span>. Built for developers, by developers.
            </p>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <SignInButton mode="modal">
                <button className="group relative px-10 py-5 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 rounded-2xl text-white font-bold text-lg shadow-2xl hover:shadow-purple-500/50 transition-all duration-300 hover:scale-105 flex items-center gap-3 overflow-hidden animate-gradient">
              ...
              <button className="group px-10 py-5 glass-strong rounded-2xl text-white font-bold text-lg border-2 border-purple-500/30 hover:border-purple-500 transition-all duration-300 hover:scale-105 flex items-center gap-3">
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              {[
                ...
                <div key={idx} className="glass-strong rounded-2xl p-4 text-center hover:scale-105 transition-all duration-300 border border-purple-500/20 card-3d">
                  <stat.icon className="size-6 mx-auto mb-2 text-purple-400" />
          ...
          <div className="relative animate-slide-up" style={{animationDelay: '0.2s'}}>
            <div className="relative rounded-3xl overflow-hidden shadow-2xl border-2 border-purple-500/30 hover:border-purple-500/60 transition-all duration-500 card-3d">
              ...
              />
              {/* Floating badges */}
              <div className="absolute top-6 right-6 glass-strong px-4 py-2 rounded-full border border-green-500/50 flex items-center gap-2 animate-float">
            ...
            <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-blue-500/30 rounded-full blur-2xl"></div>
          </div>
        </div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-20">
        <div className="text-center mb-20 animate-slide-up">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-strong border border-purple-500/30 mb-6">
            <StarIcon className="size-4 text-yellow-400" />
            <span className="text-sm font-semibold text-purple-200">Powerful Features</span>
          </div>
          <h2 className="text-5xl lg:text-6xl font-black mb-6">
            <span className="text-white">Everything You Need to </span>
            <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Ace Interviews</span>
          </h2>
          ...
          {[
            ...
            >
              <div className="gradient-border-inner h-full">
                <div className={`size-16 bg-gradient-to-br ${feature.gradient} rounded-2xl flex items-center justify-center mb-6 shadow-lg animate-glow`}>
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-20">
        <div className="glass-strong rounded-3xl p-12 border border-purple-500/30 text-center">
          <p className="text-3xl font-bold text-white mb-8">
            "HireFlow transformed our interview process. <span className="text-purple-400">Absolutely game-changing!</span>"
          </p>
          <div className="flex items-center justify-center gap-4">
            <div className="size-12 rounded-full bg-gradient-to-br from-purple-500 to-pink-500"></div>
            <div className="text-left">
              <p className="text-white font-bold">Tech Leaders Worldwide</p>
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-20 mb-20">
        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 p-12 text-center animate-gradient">
          <div className="relative z-10">
            <h2 className="text-5xl font-black text-white mb-6">Ready to Transform Your Interviews?</h2>
            <p className="text-xl text-purple-100 mb-8 max-w-2xl mx-auto">
              Join thousands of developers and companies already using HireFlow
            </p>
            <SignInButton mode="modal">
              <button className="px-12 py-6 bg-white text-purple-600 rounded-2xl font-black text-xl shadow-2xl hover:scale-105 transition-all duration-300 flex items-center gap-3 mx-auto">
